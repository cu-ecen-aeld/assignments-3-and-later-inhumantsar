...
CROSS_COMPILE_DIR=/home/inhumantsar/arm-cross-compile
...
# TODO: interpreter?
(cp ${CROSS_COMPILE_DIR}/aarch64-none-linux-gnu/libc/lib/ld-linux-aarch64.so.1 \
    ${ROOTFS_DIR}/lib/ \
...
for l in "libm.so.6" "libresolv.so.2" "libc.so.6"; do
    (cp ${CROSS_COMPILE_DIR}/aarch64-none-linux-gnu/libc/lib64/${l} \
        ${ROOTFS_DIR}/lib64/ \
